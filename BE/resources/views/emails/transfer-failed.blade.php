...
<head>
    ...
    <style>
        ...
        .amount-box { background: #FEF2F2; border: 1px solid #FCA5A5; border-radius: 8px; padding: 20px; text-align: center; margin: 24px 0; }
        .amount-box .label { font-size: 13px; color: #6B7280; margin: 0 0 8px; }
        .amount-box .amount { font-size: 28px; font-weight: bold; color: #DC2626; margin: 0; }
...
<body>
    <div class="wrapper">
        ...
        <div class="body">
            ...
            <p>Maaf, transfer kamu tidak berhasil diproses.</p>

            <div class="amount-box">
                <p class="label">Jumlah Transfer</p>
            ...
            <p style="margin-top: 24px;">Saldo kamu tidak berubah. Silakan coba kembali atau hubungi dukungan jika masalah berlanjut.</p>
        </div>
        <div class="footer">
