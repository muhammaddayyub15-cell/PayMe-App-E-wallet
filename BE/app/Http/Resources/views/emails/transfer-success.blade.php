...
<head>
    ...
    <style>
        ...
        .amount-box { background: #EFF6FF; border: 1px solid #93C5FD; border-radius: 8px; padding: 20px; text-align: center; margin: 24px 0; }
        .amount-box .label { font-size: 13px; color: #6B7280; margin: 0 0 8px; }
        .amount-box .amount { font-size: 28px; font-weight: bold; color: #1D4ED8; margin: 0; }
...
<body>
    <div class="wrapper">
        ...
        <div class="body">
            ...
            <p>Transfer kamu berhasil dikirim.</p>
            ...
            <div>
                ...
                <div class="detail-row">
                    <span class="detail-label">Saldo Setelah Transfer</span>
